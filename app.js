...
function renderNewTodo(newTodo){
  ...
  //id 정보를 newTodo가 알고잇음. newTodo 써야해서 ()안에 newTOdo 넣음. -> renderNewTodo(newTodo); -> renderNewTodo(newTodo)
...
(function(){
  ...
  window.onload = function() {
    ...
    for (let i = 1; i <= maxDay; i++) {
      var d = i > day && lastDay >= i - day ? i - day : '';
  ...
  ///////////////////////////TP///////////////////////////
  //달력 날짜를 눌렀을 때, 해당 일자 일정관리 리스트.
  const $dBtn = document.querySelector('#calendar > div > div.grid.date_form.dateSel > div:nth-child(4)');
  console.log($dBtn);
